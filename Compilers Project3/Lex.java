...
public class Lex {
	...
	public void run() {//initialize everything
		String source = "finalTestProgram3.txt";
	...
	void machineLoop() {
		...
		while(line.length() > 1) {
			...
			line = id.check(line, lfm, tfm, lineCount, resWordFile, this);
			//System.out.println("Line after ID/RES machine " + line);
			line = ws.check(line, lfm, tfm, lineCount, resWordFile, this);
			//System.out.println("Line after WhiteSpace machine " + line);
			line = nm.check(line, lfm, tfm, lineCount, resWordFile, this);
			//System.out.println("Line after Num machine " + line);
			line = sm.check(line, lfm, tfm, lineCount, resWordFile, this);
			//System.out.println("Line after Symbol machine " + line);
			line = rm.check(line, lfm, tfm, lineCount, resWordFile, this);
			//System.out.println("Line after Relop machine " + line);
